  ...
  <div class="col s12 m9 nav nav-wrapper">
      ...
      <table class="highlight responsive-table">
        ...
        {{--   @foreach($cursos as $curso)	--}}
          <tr>
            <td>{{-- $curso->nombre --}}Nombre del curso</td>
            <td>{{-- $curso->codigo --}}Codigo del curso</td>
            <td>
       			<span><a class="none waves-effect waves-light right-align"><i class="material-icons" style="color:#f57c00 ;">note_add</i></a></span>
